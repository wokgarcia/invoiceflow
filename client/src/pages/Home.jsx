...
/* ── Simple count-up that starts 600ms after mount ──────────── */
        ...
        <div className="px-6 py-5">
          ...
          <div className="space-y-2 mb-4 pb-4 border-b border-gray-100 dark:border-gray-700">
            {[
              ...
              ['Website UI/UX — 8 hrs',  '$960.00'],
              ['Revision rounds (×2)',    '$240.00'],
            ].map(([d, a], i) => (
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Keep every client organized — contact info, company details, and full billing history in one place.',
  },
  {
    ...
    title: 'One-Click PDF',
    desc: 'Download a pixel-perfect PDF of any invoice instantly. Ready to attach and send.',
  },
  {
    ...
    desc: 'Email invoices directly to clients from the app — no switching tabs or copy-pasting.',
  },
  {
    icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>,
    title: 'Revenue Dashboard',
    desc: 'Total revenue, outstanding, and overdue at a glance. Always know where your money stands.',
  },
  {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 overflow-x-hidden">
      ...
      <section className="relative pt-16 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary-500/30 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Mock invoice */}
            <div className="flex justify-center lg:justify-end animate-fade-in-up stagger-3">
              <MockInvoice />
            </div>
          </div>
        </div>
      ...
      {/* ── Features ────────────────────────────────────────── */}
      <section className="bg-gray-50 dark:bg-gray-800/40 py-24">
      ...
      <section className="bg-white dark:bg-gray-900 py-24">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative grid sm:grid-cols-3 gap-10">
            {/* Connector */}
            <div className="hidden sm:block absolute top-6 left-[16.67%] right-[16.67%] h-0.5 bg-gradient-to-r from-primary-200 via-primary-400 to-primary-200 dark:from-primary-900 dark:via-primary-700 dark:to-primary-900" />
            ...
            {[
              ...
              { num: '3', title: 'Send & get paid',        desc: 'Email your invoice or export as PDF. Track every status in real time.' },
            ].map((s, i) => (
      ...
      <section className="py-28 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/register" className="inline-flex items-center gap-2 bg-white text-primary-700 font-semibold px-8 py-3.5 rounded-lg text-base hover:bg-primary-50 active:scale-95 transition-all duration-200 shadow-xl shadow-primary-900/30">
              Create your free account
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg>
            </Link>
            <Link to="/login" className="inline-flex items-center bg-transparent text-white border border-white/40 font-semibold px-8 py-3.5 rounded-lg text-base hover:bg-white/10 active:scale-95 transition-all duration-200">
              Sign in
            </Link>
          </div>
